...
func ws_obj(script, arguments):
	if not main.get_tree():
		return
	var obj:Node = ObjectFactory.create_object(GameState.main, GameState.main_screen, 
		script,
		"graphic",
...
func ws_bg(script, arguments):
	...
	var bg:Node = ObjectFactory.create_object(GameState.main, GameState.main_screen, script, "bg", "res://System/Graphics/PWSprite.gd", 
...
func ws_fg(script, arguments):
	if not main.get_tree():
		return
	var fg:Node = ObjectFactory.create_object(GameState.main, GameState.main_screen, script, "fg", "res://System/Graphics/PWSprite.gd", 
...
func ws_char(script, arguments):
	...
	var character = ObjectFactory.create_object(GameState.main, GameState.main_screen, 
		script,
		"portrait", 
...
func ws_ev(script, arguments):
	var ev = ObjectFactory.create_object(GameState.main, GameState.main_screen, 
		script,
		"evidence",
...
func ws_penalty(script, arguments):
	...
	var penalty = ObjectFactory.create_object(GameState.main, GameState.main_screen, script, "penalty", "res://System/UI/Penalty.gd", 
